...
<div class="parent topspace">
    <div class="block">
        ...
        <p><h2 class="centred"><span class="marked">${bread}</span> > <a href="/findauthor?id=${entity.id}">${entity.firstName} ${entity.middleName} ${entity.secondName}</a> > Редактирование</h2></p>
    </div>
</div>
